...
<div class="topic-content">
    <div class="topic-type">
        ...
        <a href="http://lv.cn/topic/add" class="pub-button">
            <i class="k-i-edit"></i><span class="pub-text">发布话题</span>
        </a>
    </div>
<!--topic-list s-->
<div class="topic-list">
    @forelse($searchTopics as $row)
        <div class="topic-item">
            ...
            <div class="brief-content">
                ...
                <div class="topic-info">
                    ...
                    <div class="topic-tags"><?php  $tags = unserialize($row['tags']);
                        if ($tags){
                            foreach ($tags as $val){
    ...
    @empty
        <div style="height: 530px;position: relative">
            <div style="position: absolute;top: 50%;left: 50%;-webkit-transform: translate(-50%,-50%);transform: translate(-50%,-50%);text-align: center">
                ...
                <p style="font-size: 12px; padding-top: 10px;color: #999">没有搜到任何数据~</p>
            </div>
        </div>
    @endforelse
